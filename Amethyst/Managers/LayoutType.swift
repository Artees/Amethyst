...
enum LayoutType<Window: WindowType>: String, CaseIterable {
    ...
    case threeColumnMiddleNarrow = "3column-middle-narrow"
    ...
    var layoutClass: Layout<Window>.Type {
        ...
        case .threeColumnMiddleNarrow:
            return ThreeColumnMiddleNarrowLayout<Window>.self
        case .fullscreen:
    ...
    static func decoded(data: Data, key: String) throws -> Layout<Window> {
        ...
        case .threeColumnMiddleNarrow:
            return try decoder.decode(ThreeColumnMiddleNarrowLayout.self, from: data)
        case .fullscreen:
